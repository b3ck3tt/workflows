...
def evaluate_model_cv(
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(split_iter):
        ...
        if model_name == "hist_gbrt":
            X_train_fit = X_train.toarray() if sparse.issparse(X_train) else X_train
            X_test_fit = X_test.toarray() if sparse.issparse(X_test) else X_test
        else:
            X_train_fit = X_train
            X_test_fit = X_test
